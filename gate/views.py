...
@permission_required("gate.view_student")
...
@permission_required("gate.view_movementlog")
def logs(request):
...
@permission_required("gate.can_toggle_status")
...
@permission_required("gate.add_student")
...
@permission_required("gate.change_student")
